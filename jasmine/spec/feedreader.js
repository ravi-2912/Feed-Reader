...
$(function() {
    ...
    */
    ...
    /* This test suite is for testing the menu visibility */
    describe('The Menu', function() {
         ...
         */
        it('change visibility on menu icon click', function() {
            $menuIcon.click();
    ...
    describe('Initial Entries', function() {
         ...
         * Note that, loadFeed() is asynchronous so this test will require
    ...
    describe('New Feed Selection', function() {
         ...
         * Function loadFeed() is asynchronous.
         */
